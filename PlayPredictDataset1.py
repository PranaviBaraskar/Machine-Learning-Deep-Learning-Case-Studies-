...
def Play_Predictor_KNN(data_path,Data_test1, Data_test2):
    ...
    weather_encoded = obj.fit_transform(whether)
    print("Whether : ")
    print(weather_encoded)

    temp_encoded = obj.fit_transform(Temp)
    label = obj.fit_transform(Labels)
    ...
    clf = clf.fit(feautures,label)

    predicted = clf.predict([[Data_test1,Data_test2]])
